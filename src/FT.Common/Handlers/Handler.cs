...
namespace FT.Common.Handlers
{
    public class Handler : IHandler
    {
        ...
        private Func<FTException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<FTException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (FTException customException)
            {
                isFailure = true;
