...
namespace DFF.Common.Handlers
{
    public class Handler : IHandler
    {
        ...
        private Func<DFFException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<DFFException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (DFFException customException)
            {
                isFailure = true;
